...
func FirstaddTwoNumbers(l1 *gobase.ListNode, l2 *gobase.ListNode) *gobase.ListNode {
	//TODO
	/* 1 LIST转STR
	 * 2 STR转INT相加
	...
	//1
	var Str1 string
	Str1 = gobase.ListNodeToSrting(l1)

	var Str2 string
	Str2 = gobase.ListNodeToSrting(l2)
	...
	fmt.Println(reverse)
	rListNode := gobase.AddListNode(reverse)
	return &rListNode
}
